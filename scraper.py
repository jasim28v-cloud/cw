...
<body>
    ...
    <section id="home" class="hero-section">
        <div class="hero-content">
            <div class="glass-card hero-card">
                ...
                <h1 class="hero-title">
                    أهلاً بك في<br>
                    <span class="gold-text">سوق كواغد</span>
                </h1>
                <p class="hero-description">
                    وجهتك الأولى لشراء وبيع الأغراض المستعملة. نوفر لك منصة آمنة وسهلة للعثور على أفضل الصفقات أو بيع أغراضك بأفضل الأسعار.
                </p>
                <div class="hero-actions">
                    ...
                    <button class="glass-btn secondary-btn" onclick="scrollToSection('sell')">
    ...
    <section class="features-section">
        <div class="features-grid">
            <div class="glass-card feature-card">
                ...
                <h3>أسعار تنافسية</h3>
                <p>أفضل الأسعار للأغراض المستعملة بحالة ممتازة</p>
            </div>
            <div class="glass-card feature-card">
                <div class="feature-icon">
                ...
                <h3>تعامل آمن</h3>
                <p>نظام تقييم للبائعين والمشترين لضمان المصداقية</p>
            </div>
            <div class="glass-card feature-card">
                <div class="feature-icon">
                ...
                <h3>منتجات متنوعة</h3>
                <p>آلاف المنتجات المستعملة في مكان واحد</p>
            </div>
            <div class="glass-card feature-card">
                <div class="feature-icon">
    ...
    <section id="sell" class="sell-section">
        <div class="section-header">
            <span class="section-badge">بيع منتجك</span>
            <h2 class="section-title">اعرض <span class="gold-text">أغراضك</span> للبيع</h2>
            <p class="section-description">املأ النموذج التالي لعرض منتجك المستعمل في سوق كواغد</p>
        </div>
        ...
        <form class="glass-card sell-form" id="sellForm">
            <div class="form-section">
                ...
                <div class="upload-glass" id="uploadAreaSell">
                    ...
                    <div class="upload-content">
                        ...
                        <button type="button" class="glass-btn secondary-btn" onclick="document.getElementById('imageUploadSell').click()">
                            <i class="fas fa-folder-open"></i>
                            اختر صورة
                        </button>
                    </div>
                </div>
                <div id="uploadProgressSell" class="upload-progress"></div>
                <div id="imagePreviewSell" class="image-preview-glass"></div>
                <input type="hidden" id="sellProductImage" required>
            </div>
            
            <div class="form-row">
                <div class="input-glass">
                    <i class="fas fa-tag"></i>
                    <input type="text" id="sellProductName" placeholder="اسم المنتج" required>
                </div>
                <div class="input-glass">
                    <i class="fas fa-dollar-sign"></i>
                    <input type="number" id="sellProductPrice" placeholder="السعر ($)" required step="0.01">
                </div>
            </div>
            
            <div class="input-glass">
                <i class="fas fa-layer-group"></i>
                <select id="sellProductCategory" required>
            ...
            <div class="input-glass">
                ...
                <select id="sellProductCondition" required>
            ...
            <div class="input-glass">
                ...
                <textarea id="sellProductDescription" placeholder="وصف المنتج وحالته بالتفصيل..." rows="4" required></textarea>
            </div>
            
            <div class="input-glass">
                <i class="fas fa-map-marker-alt"></i>
                <input type="text" id="sellProductLocation" placeholder="موقع المنتج (المدينة)" required>
            </div>
            
            <div class="input-glass">
                <i class="fas fa-phone"></i>
                <input type="tel" id="sellProductPhone" placeholder="رقم التواصل (اختياري)">
            </div>
            
            <button type="submit" class="glass-btn primary-btn full-width">
    ...
    <section id="products" class="products-section">
        <div class="section-header">
            <span class="section-badge">المنتجات</span>
            <h2 class="section-title">أغراض <span class="gold-text">مستعملة</span> للبيع</h2>
            <p class="section-description">تصفح أحدث العروض من البائعين في سوق كواغد</p>
        </div>
        ...
        <div class="filter-buttons">
            ...
            <button class="filter-btn" onclick="filterProducts('electronics')">
                <i class="fas fa-mobile-alt"></i> إلكترونيات
            </button>
            <button class="filter-btn" onclick="filterProducts('furniture')">
                <i class="fas fa-couch"></i> أثاث
            </button>
            <button class="filter-btn" onclick="filterProducts('clothing')">
                <i class="fas fa-tshirt"></i> ملابس
            </button>
            <button class="filter-btn" onclick="filterProducts('books')">
                <i class="fas fa-book"></i> كتب
            </button>
            <button class="filter-btn" onclick="filterProducts('sports')">
                <i class="fas fa-futbol"></i> رياضة
            </button>
            <button class="filter-btn" onclick="filterProducts('toys')">
                <i class="fas fa-puzzle-piece"></i> ألعاب
            </button>
            <button class="filter-btn" onclick="filterProducts('other')">
    ...
    <section id="about" class="about-section">
        <div class="about-content">
            <div class="about-text">
                ...
                <h2>قصة <span class="gold-text">كواغد</span></h2>
                <p>كواغد هو سوق متكامل لبيع وشراء الأغراض المستعملة. نؤمن بأن كل غرض مستعمل له قيمة ويمكن أن يكون كنزاً لشخص آخر. نوفر منصة آمنة وسهلة الاستخدام تجمع بين البائعين والمشترين في مكان واحد.</p>
                <p>هدفنا تعزيز ثقافة إعادة الاستخدام وتقليل الهدر مع توفير فرص رائعة للجميع للحصول على ما يحتاجونه بأسعار معقولة.</p>
                <div class="stats-grid">
                    <div class="glass-card stat-card">
                        <span class="stat-number">+5000</span>
                        <span class="stat-label">منتج معروض</span>
                    </div>
                    <div class="glass-card stat-card">
                    ...
                    <div class="glass-card stat-card">
                        ...
                        <span class="stat-label">صفقة ناجحة</span>
                    </div>
                </div>
            </div>
    ...
    <div id="adminPanel" class="admin-panel glass-panel">
        ...
        <form id="productForm" class="admin-form">
            ...
            <div class="form-section">
                ...
                <div class="input-glass">
                    <i class="fas fa-dollar-sign"></i>
                    <input type="number" id="productPrice" placeholder="السعر ($)" required step="0.01">
                </div>
    ...
    <footer class="glass-footer">
        <div class="footer-content">
            <div class="footer-brand">
                <i class="fas fa-recycle"></i>
                <h3>كواغد</h3>
                <p>سوق الأغراض المستعملة الأول</p>
            </div>
            <div class="footer-links">
                <h4>روابط سريعة</h4>
                <a href="#home">الرئيسية</a>
                <a href="#products">المنتجات</a>
                <a href="#sell">بيع منتجك</a>
                <a href="#about">من نحن</a>
                <a href="#contact">اتصل بنا</a>
            </div>
            <div class="footer-contact">
                <h4>تواصل معنا</h4>
                <p><i class="fas fa-envelope"></i> info@kwaged.com</p>
        ...
        <div class="footer-bottom">
            <p>© 2024 كواغد - جميع الحقوق محفوظة</p>
        </div>
    </footer>
...
:root {
    ...
    /* Green Theme for Second-hand Market */
    --gold: #4CAF50;
    --gold-light: #A5D6A7;
    --gold-dark: #2E7D32;
...
def create_products_js():
    """ملف المنتجات - سوق كواغد"""
    js = '''// Products Database for كواغد
const productsDB = [
    {
        id: 1,
        name: "آيفون 12 برو - 256GB",
        price: 450,
        category: "electronics",
        description: "جهاز آيفون 12 برو سعة 256GB بحالة ممتازة، مع الشاحن والكرتونة الأصلية. تم استخدامه لمدة سنة واحدة فقط.",
        condition: "excellent",
        location: "نيويورك",
        phone: "1234567890",
        image: "https://res.cloudinary.com/dmla61v7n/image/upload/v1/kwaged/iphone12",
        badge: "الأكثر طلباً"
    },
    {
        id: 2,
        ...
        price: 180,
        category: "furniture",
        description: "طاولة طعام من الخشب الصلب تتسع لـ 6 أشخاص، بحالة جيدة جداً مع بعض الخدوش البسيطة على السطح.",
        condition: "good",
        location: "لوس أنجلوس",
        phone: "9876543210",
        image: "https://res.cloudinary.com/dmla61v7n/image/upload/v1/kwaged/table",
        badge: ""
    },
    {
        id: 3,
        name: "مجموعة كتب برمجة",
        price: 35,
        category: "books",
        description: "مجموعة من 5 كتب برمجة تشمل Python، JavaScript، React، Node.js، و SQL. الكتب بحالة مثل الجديدة.",
        condition: "like-new",
        location: "شيكاغو",
        phone: "",
        image: "https://res.cloudinary.com/dmla61v7n/image/upload/v1/kwaged/books",
        badge: "صفقة ممتازة"
    },
    {
        id: 4,
        ...
        price: 220,
        category: "sports",
        description: "دراجة جبلية من ماركة Trek مقاس 29 بوصة، استخدمت لفترة قصيرة فقط. بحالة ممتازة مع كامل الإكسسوارات.",
        condition: "excellent",
        location: "بوسطن",
        phone: "5551112233",
        image: "https://res.cloudinary.com/dmla61v7n/image/upload/v1/kwaged/bike",
        badge: ""
    },
    {
        id: 5,
        ...
        price: 380,
        category: "electronics",
        description: "جهاز بلاي ستيشن 5 مع يدين تحكم و 3 ألعاب. الجهاز بحالة ممتازة وتم شراؤه قبل 6 أشهر.",
        condition: "excellent",
        location: "ميامي",
        phone: "4445556667",
        image: "https://res.cloudinary.com/dmla61v7n/image/upload/v1/kwaged/ps5",
        badge: "جديد"
    },
    {
        id: 6,
        name: "كنبة جلدية 3 مقاعد",
        price: 280,
        category: "furniture",
        description: "كنبة جلدية لون بني غامق، 3 مقاعد. بحالة جيدة مع بعض علامات الاستخدام العادية. مريحة جداً.",
        condition: "good",
        location: "دالاس",
        phone: "",
        image: "https://res.cloudinary.com/dmla61v7n/image/upload/v1/kwaged/sofa",
        badge: ""
    },
    {
        id: 7,
        name: "فساتين نسائية ماركات",
        price: 45,
        category: "clothing",
        description: "مجموعة من 4 فساتين نسائية ماركات مختلفة، مقاس M، بحالة ممتازة (تم ارتداؤها مرة أو مرتين فقط).",
        condition: "excellent",
        location: "سان فرانسيسكو",
        phone: "3332221110",
        image: "https://res.cloudinary.com/dmla61v7n/image/upload/v1/kwaged/dresses",
        badge: ""
    },
    {
        id: 8,
        name: "مجسمات ليغو ستار وورز",
        price: 95,
        category: "toys",
        description: "مجموعة مجسمات ليغو ستار وورز نادرة، مكتملة القطع مع الكتيب. بحالة ممتازة جداً.",
        condition: "like-new",
        location: "سياتل",
        phone: "9998887776",
        image: "https://res.cloudinary.com/dmla61v7n/image/upload/v1/kwaged/lego",
        badge: "نادر"
    }
];
...
function saveProducts() {
    localStorage.setItem('kwagedProducts', JSON.stringify(products));
}

function saveCart() {
    localStorage.setItem('kwagedCart', JSON.stringify(cart));
}
        ...
        <div class="glass-card product-card">
            ...
            <div class="product-image-wrapper">
                <img src="${product.image}" alt="${product.name}" class="product-image" 
                     onerror="this.src='https://res.cloudinary.com/dmla61v7n/image/upload/v1/kwaged/placeholder'">
            </div>
            <div class="product-info">
                ...
                <div class="product-actions">
                    ...
                    ${product.phone ? `
                    <a href="tel:${product.phone}" class="glass-btn secondary-btn" title="اتصل بالبائع">
                        <i class="fas fa-phone"></i>
                    </a>` : ''}
                </div>
            </div>
    ...
    container.innerHTML = cart.map((item, index) => `
        <div style="display: flex; gap: 1rem; padding: 1rem; margin-bottom: 0.5rem; 
            ...
            <div style="flex: 1;">
                ...
                <p style="color: var(--text-secondary); font-size: 0.9rem;">$${item.price.toFixed(2)} | ${item.location}</p>
            </div>
    ...
    if (sellForm) {
        sellForm.addEventListener('submit', function(e) {
            ...
            const newProduct = {
                ...
                image: document.getElementById('sellProductImage').value || 'https://res.cloudinary.com/dmla61v7n/image/upload/v1/kwaged/placeholder',
                badge: 'جديد'
            };
            ...
            document.getElementById('uploadProgressSell').innerHTML = '';
            showToast('🎉 تم إضافة منتجك بنجاح! سيظهر في السوق فوراً.', 'success');
...
function verifyPin() {
    ...
    if (pin === ADMIN_PIN) {
        ...
        showToast('✅ تم الدخول إلى لوحة تحكم كواغد', 'success');
    } else {
...
async function handleImageUpload(event) {
    ...
    formData.append('upload_preset', 'kwaged-store');
...
// Cloudinary Upload for Sell Form
async function handleSellImageUpload(event) {
    const file = event.target.files[0];
    if (!file) return;

    const uploadArea = document.getElementById('uploadAreaSell');
    const progress = document.getElementById('uploadProgressSell');
    const preview = document.getElementById('imagePreviewSell');
...
document.getElementById('productForm').addEventListener('submit', function(e) {
    ...
    displayProducts();
    resetAdminForm();
    showToast('🎉 تم إضافة المنتج بنجاح إلى سوق كواغد!', 'success');
});
...
function initApp() {
    ...
    setupDragDrop('uploadAreaSell', 'imageUploadSell');
}
...
def main():
    ...
    print("🏪 اسم المتجر: كواغد")
    print("💵 العملة: دولار أمريكي ($)")
    print("📦 النوع: سوق الأغراض المستعملة")
